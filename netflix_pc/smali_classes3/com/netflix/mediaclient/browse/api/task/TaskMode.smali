...
# static fields
.field private static final synthetic b:[Lcom/netflix/mediaclient/browse/api/task/TaskMode;

.field public static final enum c:Lcom/netflix/mediaclient/browse/api/task/TaskMode;

.field public static final enum d:Lcom/netflix/mediaclient/browse/api/task/TaskMode;

.field public static final enum e:Lcom/netflix/mediaclient/browse/api/task/TaskMode;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2}, Lcom/netflix/mediaclient/browse/api/task/TaskMode;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/netflix/mediaclient/browse/api/task/TaskMode;->d:Lcom/netflix/mediaclient/browse/api/task/TaskMode;

    .line 9
    new-instance v1, Lcom/netflix/mediaclient/browse/api/task/TaskMode;

    const-string v2, "FROM_CACHE_OR_NETWORK"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lcom/netflix/mediaclient/browse/api/task/TaskMode;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/netflix/mediaclient/browse/api/task/TaskMode;->e:Lcom/netflix/mediaclient/browse/api/task/TaskMode;

    .line 10
    new-instance v2, Lcom/netflix/mediaclient/browse/api/task/TaskMode;

    const-string v3, "FROM_NETWORK"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/netflix/mediaclient/browse/api/task/TaskMode;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/netflix/mediaclient/browse/api/task/TaskMode;->c:Lcom/netflix/mediaclient/browse/api/task/TaskMode;

    .line 1007
    filled-new-array {v0, v1, v2}, [Lcom/netflix/mediaclient/browse/api/task/TaskMode;
