...
.method static constructor <clinit>()V
    ...
    .line 10
    new-instance v1, Lorg/linphone/tools/Xml2Lpc$LogLevel;

    const-string v2, "MESSAGE"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lorg/linphone/tools/Xml2Lpc$LogLevel;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lorg/linphone/tools/Xml2Lpc$LogLevel;->MESSAGE:Lorg/linphone/tools/Xml2Lpc$LogLevel;

    .line 11
    new-instance v2, Lorg/linphone/tools/Xml2Lpc$LogLevel;

    const-string v3, "WARNING"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lorg/linphone/tools/Xml2Lpc$LogLevel;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lorg/linphone/tools/Xml2Lpc$LogLevel;->WARNING:Lorg/linphone/tools/Xml2Lpc$LogLevel;

    .line 12
    new-instance v3, Lorg/linphone/tools/Xml2Lpc$LogLevel;

    const-string v4, "ERROR"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lorg/linphone/tools/Xml2Lpc$LogLevel;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lorg/linphone/tools/Xml2Lpc$LogLevel;->ERROR:Lorg/linphone/tools/Xml2Lpc$LogLevel;

    .line 8
    filled-new-array {v0, v1, v2, v3}, [Lorg/linphone/tools/Xml2Lpc$LogLevel;
