.class public final Lcom/netflix/mediaclient/storage/db/OfflineDatabase$f;
.super Lo/aJx;
.source ""
...
.method public final a(Lo/aJM;)V
    ...
    .line 227
    const-string v0, "CREATE TABLE `tempTable` (`playableId` TEXT NOT NULL, `profileId` TEXT NOT NULL, `bookmarkInMs` INTEGER NOT NULL, `bookmarkUpdateTimeInUTCMs` INTEGER NOT NULL, PRIMARY KEY(`profileId`, `playableId`))"

    invoke-interface {p1, v0}, Lo/aJM;->c(Ljava/lang/String;)V

    .line 228
    const-string v0, "INSERT INTO `tempTable` SELECT playableId, profileId, bookmarkInSecond, bookmarkUpdateTimeInUTCMs from `bookmarkStore`"

    invoke-interface {p1, v0}, Lo/aJM;->c(Ljava/lang/String;)V

    .line 229
    const-string v0, "UPDATE `tempTable` set bookmarkInMs = bookmarkInMs*1000"

    invoke-interface {p1, v0}, Lo/aJM;->c(Ljava/lang/String;)V

    .line 230
    const-string v0, "DROP TABLE `bookmarkStore`"

    invoke-interface {p1, v0}, Lo/aJM;->c(Ljava/lang/String;)V

    .line 231
    const-string v0, "ALTER TABLE tempTable RENAME TO `bookmarkStore`"
    ...
    .line 236
    const-string v0, "UPDATE `tempTable` set bookmarkMs = bookmarkMs*1000"
