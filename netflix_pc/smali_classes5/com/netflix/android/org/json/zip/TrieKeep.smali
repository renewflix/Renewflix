...
.method public postMortem(Lcom/netflix/android/org/json/zip/PostMortem;)Z
    ...
    .line 249
    iget v0, p0, Lcom/netflix/android/org/json/zip/Keep;->length:I
    ...
    iget p1, p1, Lcom/netflix/android/org/json/zip/Keep;->length:I
    ...
    iget v1, p1, Lcom/netflix/android/org/json/zip/Keep;->capacity:I
    ...
    iget v1, p0, Lcom/netflix/android/org/json/zip/Keep;->capacity:I

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget p1, p1, Lcom/netflix/android/org/json/zip/Keep;->capacity:I
    ...
    .line 258
    :goto_0
    iget v5, p0, Lcom/netflix/android/org/json/zip/Keep;->length:I
...
.method public registerMany(Lcom/netflix/android/org/json/Kim;)V
    ...
    .line 284
    invoke-virtual {p1, v5}, Lcom/netflix/android/org/json/Kim;->get(I)I

    move-result v6

    invoke-virtual {v4, v6}, Lcom/netflix/android/org/json/zip/TrieKeep$Node;->vet(I)Lcom/netflix/android/org/json/zip/TrieKeep$Node;
    ...
    .line 287
    iget v6, p0, Lcom/netflix/android/org/json/zip/Keep;->length:I

    invoke-static {v4, v6}, Lcom/netflix/android/org/json/zip/TrieKeep$Node;->access$002(Lcom/netflix/android/org/json/zip/TrieKeep$Node;I)I

    .line 288
    iget-object v6, p0, Lcom/netflix/android/org/json/zip/Keep;->uses:[J

    iget v7, p0, Lcom/netflix/android/org/json/zip/Keep;->length:I
    ...
    .line 289
    iget-object v6, p0, Lcom/netflix/android/org/json/zip/TrieKeep;->kims:[Lcom/netflix/android/org/json/Kim;
    ...
    .line 299
    iput v7, p0, Lcom/netflix/android/org/json/zip/Keep;->length:I
...
.method public registerOne(Lcom/netflix/android/org/json/Kim;II)I
    ...
    invoke-virtual {v0, v3}, Lcom/netflix/android/org/json/zip/TrieKeep$Node;->vet(I)Lcom/netflix/android/org/json/zip/TrieKeep$Node;
    ...
    .line 325
    invoke-static {v0, v1}, Lcom/netflix/android/org/json/zip/TrieKeep$Node;->access$002(Lcom/netflix/android/org/json/zip/TrieKeep$Node;I)I
    ...
    .line 336
    iget p1, p0, Lcom/netflix/android/org/json/zip/Keep;->length:I
...
.method public reserve()V
    ...
    .line 354
    :goto_0
    iget v4, p0, Lcom/netflix/android/org/json/zip/Keep;->capacity:I

    if-ge v2, v4, :cond_2

    .line 355
    iget-object v4, p0, Lcom/netflix/android/org/json/zip/Keep;->uses:[J
    ...
    invoke-static {v7, v8}, Lcom/netflix/android/org/json/zip/Keep;->age(J)J
    ...
    .line 381
    :cond_3
    iput v3, p0, Lcom/netflix/android/org/json/zip/Keep;->length:I
    ...
    .line 383
    iget-object v1, p0, Lcom/netflix/android/org/json/zip/Keep;->uses:[J
