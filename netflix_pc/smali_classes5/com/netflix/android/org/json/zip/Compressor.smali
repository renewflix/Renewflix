...
.method private writeJSON(Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p1}, Lcom/netflix/android/org/json/zip/Compressor;->writeObject(Lcom/netflix/android/org/json/JSONObject;)V
    ...
    invoke-direct {p0, p1}, Lcom/netflix/android/org/json/zip/Compressor;->writeArray(Lcom/netflix/android/org/json/JSONArray;)V
...
.method private writeName(Ljava/lang/String;)V
    ...
    .line 323
    iget-object p1, p0, Lcom/netflix/android/org/json/zip/JSONzip;->namekeep:Lcom/netflix/android/org/json/zip/MapKeep;
    ...
    .line 332
    iget-object p1, p0, Lcom/netflix/android/org/json/zip/JSONzip;->namehuff:Lcom/netflix/android/org/json/zip/Huff;
    ...
    .line 333
    iget-object v1, p0, Lcom/netflix/android/org/json/zip/JSONzip;->namehuff:Lcom/netflix/android/org/json/zip/Huff;
...
.method private writeString(Ljava/lang/String;)V
    ...
    .line 403
    iget-object p1, p0, Lcom/netflix/android/org/json/zip/JSONzip;->stringkeep:Lcom/netflix/android/org/json/zip/MapKeep;
...
.method private writeSubstring(Lcom/netflix/android/org/json/Kim;)V
    ...
    .line 439
    iget-object v6, p0, Lcom/netflix/android/org/json/zip/JSONzip;->substringkeep:Lcom/netflix/android/org/json/zip/TrieKeep;

    invoke-virtual {v6, p1, v5, v0}, Lcom/netflix/android/org/json/zip/TrieKeep;->match(Lcom/netflix/android/org/json/Kim;II)I
    ...
    .line 478
    iget-object v5, p0, Lcom/netflix/android/org/json/zip/JSONzip;->substringhuff:Lcom/netflix/android/org/json/zip/Huff;

    invoke-direct {p0, p1, v1, v0, v5}, Lcom/netflix/android/org/json/zip/Compressor;->write(Lcom/netflix/android/org/json/Kim;IILcom/netflix/android/org/json/zip/Huff;)V
    ...
    invoke-virtual {v0, p1, v4, v3}, Lcom/netflix/android/org/json/zip/TrieKeep;->registerOne(Lcom/netflix/android/org/json/Kim;II)I

    .line 483
    :cond_1
    iget-object v0, p0, Lcom/netflix/android/org/json/zip/JSONzip;->substringhuff:Lcom/netflix/android/org/json/zip/Huff;

    invoke-direct {p0, v7, v0}, Lcom/netflix/android/org/json/zip/Compressor;->write(ILcom/netflix/android/org/json/zip/Huff;)V
    ...
    .line 454
    iget-object v8, p0, Lcom/netflix/android/org/json/zip/JSONzip;->substringhuff:Lcom/netflix/android/org/json/zip/Huff;

    invoke-direct {p0, p1, v1, v5, v8}, Lcom/netflix/android/org/json/zip/Compressor;->write(Lcom/netflix/android/org/json/Kim;IILcom/netflix/android/org/json/zip/Huff;)V

    .line 455
    iget-object v1, p0, Lcom/netflix/android/org/json/zip/JSONzip;->substringhuff:Lcom/netflix/android/org/json/zip/Huff;

    invoke-direct {p0, v7, v1}, Lcom/netflix/android/org/json/zip/Compressor;->write(ILcom/netflix/android/org/json/zip/Huff;)V

    if-eq v4, v2, :cond_3

    .line 457
    iget-object v1, p0, Lcom/netflix/android/org/json/zip/JSONzip;->substringkeep:Lcom/netflix/android/org/json/zip/TrieKeep;

    invoke-virtual {v1, p1, v4, v3}, Lcom/netflix/android/org/json/zip/TrieKeep;->registerOne(Lcom/netflix/android/org/json/Kim;II)I
    ...
    invoke-direct {p0, v6, v1}, Lcom/netflix/android/org/json/zip/Compressor;->writeAndTick(ILcom/netflix/android/org/json/zip/Keep;)V

    .line 464
    iget-object v1, p0, Lcom/netflix/android/org/json/zip/JSONzip;->substringkeep:Lcom/netflix/android/org/json/zip/TrieKeep;

    invoke-virtual {v1, v6}, Lcom/netflix/android/org/json/zip/TrieKeep;->length(I)I
    ...
    invoke-virtual {v6, p1, v4, v3}, Lcom/netflix/android/org/json/zip/TrieKeep;->registerOne(Lcom/netflix/android/org/json/Kim;II)I
...
.method private writeValue(Ljava/lang/Object;)V
    ...
    .line 502
    iget-object v3, p0, Lcom/netflix/android/org/json/zip/JSONzip;->values:Lcom/netflix/android/org/json/zip/MapKeep;
    ...
    .line 505
    iget-object p1, p0, Lcom/netflix/android/org/json/zip/JSONzip;->values:Lcom/netflix/android/org/json/zip/MapKeep;
    ...
    .line 532
    :cond_5
    sget p1, Lcom/netflix/android/org/json/zip/JSONzip;->endOfNumber:I
...
.method public zip(Lcom/netflix/android/org/json/JSONArray;)V
    ...
    .line 572
    invoke-virtual {p0}, Lcom/netflix/android/org/json/zip/JSONzip;->begin()V
